# Filter Doctors As Patient (Authenticated Patient)
...
## User Story
_As an authenticated patient user, I want to filter doctors from the list of doctors with available time slots,
...
Scenario: Filter doctors by name, specialty, and time
  Given I am on the protected patient dashboard page
...
## Additional Notes
- This feature belongs to the protected patient dashboard EPIC.
